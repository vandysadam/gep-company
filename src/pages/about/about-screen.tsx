  ...
  useEffect(() => {
    ...
    return (
      <DashboardLayout>
        ...
        <div className="absolute font-bold text-[40px] sm:text-[90px] lg:text-[124px] text-stone-400 font-arial px-5 -mt-10 sm:-mt-[100px] lg:-mt-[115px] bg-neutral-50" data-aos="fade-right"><h2>LINGKUP QS</h2></div>
